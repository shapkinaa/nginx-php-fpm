 ...
 * @version    SVN: $Id: index.php 2617 2014-05-25 22:33:56Z oheil $
 */
...
?>
            <form action="action.php?<?php echo NOCC_Session::getUrlGetSession(); ?>" method="post" id="nocc_webmail_login">
            <div id="loginBox">
