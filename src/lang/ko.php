 ...
 * @version    SVN: $Id: ko.php 2623 2014-10-06 10:07:46Z siebrand $
 */
/** Korean (한국어)
 * 
...
$html_trash_folder_label = '삭제된 이메일을 전용 폴더 안으로 옮기기:';
$html_colored_quotes = '색이 있는 인용';
$html_display_struct = '구조된 텍스트 보기';
...
$html_down_mail = '다운로드';
$original_msg = '-- 원래 메시지 --';
$to_empty = '\'받는이\' 필드는 비어 있으면 안됩니다!';
$html_images_warning = '보안을 위해, 원격 사진을 보여주지 않습니다.';
$html_images_display = '사진 보기';
